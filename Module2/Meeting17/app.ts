...
function firstRoom() {
    ...
    // get player action
    const action = prompt("You stand before the shelves of ancient books. What would you like to do?\n" +
...
function secondRoom() {
    ...
    const action = prompt("The laboratory is filled with strange instruments and mysterious substances. What would you like to do?\n" +
...
function thirdRoom() {
    ...
    const action = prompt("The hall is filled with standing suits of armor. What would you like to do?\n" +
